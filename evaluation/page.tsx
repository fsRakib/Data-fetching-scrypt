...
export default function EvaluationPage() {
  ...
  const [leftParsed, setLeftParsed] = useState<ReturnType<
    typeof parseResponse
  > | null>(null);
  const [rightParsed, setRightParsed] = useState<ReturnType<
    typeof parseResponse
  > | null>(null);
  ...
  const fetchNextPair = useCallback(async () => {
    try {
      ...
      // Parse responses for proper formatting
      setLeftParsed(parseResponse(result.data.leftResponse));
      setRightParsed(parseResponse(result.data.rightResponse));
      // Reset form
        ...
        <Card className="max-w-md w-full mx-4">
          <CardContent className="pt-6 text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              You&apos;ve completed all available evaluations. Thank you for
              your contribution!
            </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-8">
          <ResponseCard
            title="System A (Current)"
            parsedResponse={leftParsed}
            scores={leftScores}
          ...
          />
          <ResponseCard
            title="System B (Alternative)"
            parsedResponse={rightParsed}
            scores={rightScores}
            onScoreChange={(dimension, value) =>
